...
function gtext(){
	...
	if ($paystack_id != '') {
		...
		$data['paystack_public_key']  = $paystackObj->paystack_public_key ?? '';
		$data['paystack_secret_key']  = $paystackObj->paystack_secret_key ?? '';
		$data['paystack_currency']    = $paystackObj->paystack_currency ?? 'NGN';
		$data['ismode_paystack']      = $paystackObj->ismode_paystack ?? 0;
		$data['isenable_paystack']    = $paystackObj->isenable_paystack ?? 0;

	} else {

		$data['paystack_public_key']  = '';
		$data['paystack_secret_key']  = '';
		$data['paystack_currency']    = 'NGN';
		$data['ismode_paystack']      = 0;
		$data['isenable_paystack']    = 0;
	}
