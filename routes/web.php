...
Route::get('/paystack/callback', [
    App\Http\Controllers\Frontend\CheckoutFrontController::class,
    'PaystackCallback'
...
Route::prefix('backend')->group(function(){
	...
	// Route::post('/backend/PaystackSettingsUpdate', [PaymentGatewayController::class, 'paystackSettingsUpdate']);

	Route::post('/PaystackSettingsUpdate', [App\Http\Controllers\Backend\SettingsController::class, 'PaystackSettingsUpdate'])->name('backend.PaystackSettingsUpdate')->middleware(['auth','is_admin']);
