								...
								<div id="list-panel">
									<div class="table-responsive">
										<table class="table table-borderless table-theme" style="width:100%;">
											<tbody>
												<tr>
    <td class="text-left" width="70%">{{ __('Paystack') }}</td>
    <td class="text-left" width="25%">
        @if($paystack_data_list['isenable_paystack'] == 1)
    ...
    <td class="text-center" width="5%">
        <div class="btn-group action-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a onclick="onEdit(7)" class="dropdown-item" href="javascript:void(0);">
                    {{ __('Edit') }}
                </a>
            </div>
        </div>
...
<div id="form-panel-7" class="dnone">
    <form 
        method="POST"
        action="{{ route('backend.PaystackSettingsUpdate') }}"
        id="paystack_formId"
    >
        @csrf
...
<div class="form-group">
    ...
    <input type="text"
           class="form-control"
           readonly
           value="{{ url('/paystack/webhook') }}">
</div>


                <div class="tw_checkbox checkbox_group">
                    <input
                        id="isenable_paystack"
                        name="isenable_paystack"
                        type="checkbox"
                        value="on"
                        {{ $paystack_data_list['isenable_paystack'] == 1 ? 'checked' : '' }}
                    >
                    <label for="isenable_paystack">{{ __('Active/Inactive') }}</label>
                    <span></span>
                </div>

                <div class="form-group">
                    <label for="paystack_public_key">
                        {{ __('Public Key') }} <span class="red">*</span>
                    </label>
                    <input
                        type="text"
                        ...
                        class="form-control"
                        required
                        value="{{ $paystack_data_list['paystack_public_key'] }}"
                    >
                </div>

                <div class="form-group">
                    <label for="paystack_secret_key">
                        {{ __('Secret Key') }} <span class="red">*</span>
                    </label>
                    <input
                        type="text"
                        ...
                        class="form-control"
                        required
                        value="{{ $paystack_data_list['paystack_secret_key'] }}"
                    >
                ...
                <div class="form-group">
                    <label for="paystack_currency">
                        {{ __('Currency') }} <span class="red">*</span>
                    </label>
                    <input
                        type="text"
                        ...
                        class="form-control"
                        required
                        value="{{ $paystack_data_list['paystack_currency'] ?? 'NGN' }}"
                    >
                </div>
                ...
                <div class="tw_checkbox checkbox_group">
                    <input
                        id="ismode_paystack"
                        name="ismode_paystack"
                        type="checkbox"
                        value="on"
                        {{ $paystack_data_list['ismode_paystack'] == 1 ? 'checked' : '' }}
                    >
                    <label for="ismode_paystack">{{ __('Test Mode') }}</label>
                    <span></span>
                </div>
