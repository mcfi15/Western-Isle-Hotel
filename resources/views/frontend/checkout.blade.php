						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="payment_card">
									<div class="checkboxlist">
										<label class="checkbox-title">
											<input id="payment_method_paystack"
												name="payment_method"
												type="radio"
												value="7">
											<img src="{{ asset('public/frontend/images/paystack.png') }}" alt="Paystack" />
										</label>
									</div>
									<p id="pay_paystack" class="hideclass">
										{{ __('Pay securely via Paystack') }}
									</p>
								</div>
								@endif
